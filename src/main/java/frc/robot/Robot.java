...
public class Robot extends TimedRobot {
    ...
    public static ServoMotor servoMotor;
    ...
    public void robotInit() {
        ...
        CommandScheduler.getInstance().registerSubsystem(servoMotor);
        CommandScheduler.getInstance().setDefaultCommand(servoMotor, new TestServo());
